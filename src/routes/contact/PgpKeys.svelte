<script>
  ...
  const keys = [
    ...
    {
      label: 'Email',
      value: 'cotonrey at omg dot lol',
      link: 'mailto:cotonrey@omg.lol',
    },
    {
      label: 'Matrix',
      value: '@cotonrey:matrix.org',
      link: 'https://matrix.to/#/@cotonrey:matrix.org',
    },
    {
      label: 'XMPP',
      value: 'cotonrey@xmpp.is',
      link: 'xmpp:cotonrey@xmpp.is?join',
    },
